...
public sealed partial class CctvDatabaseWindow : FancyWindow
{
    ...
    public void UpdateState(CctvDatabaseState state)
    {
        ...
        MessageLabel.Text = _printTime != null ? $"{Loc.GetString(PrintingMessage)}: {(_printTime.Value - _timing.CurTime).TotalSeconds:0.0}" : Loc.GetString(IdleMessage);
    }
