...
namespace Content.Server.Objectives.Conditions
{
    [UsedImplicitly]
    [DataDefinition]
    public sealed class TwitchyCondition : IObjectiveCondition
    {
        private Mind.Mind? _mind;

        public IObjectiveCondition GetAssigned(Mind.Mind mind)
        {
            return new TwitchyCondition {
                _mind = mind,
            };
        }

        public string Title => Loc.GetString("objective-condition-twitchy-title");
        ...
        {
            return other is TwitchyCondition esc && Equals(_mind, esc._mind);
        }
        ...
        public override bool Equals(object? obj)
        {
            ...
            return Equals((TwitchyCondition) obj);
        }
